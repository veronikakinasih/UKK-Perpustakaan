            ...
            <div class="row">
                @foreach ($buku as $item)
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        ...
                        <div class="card-body" style="background: linear-gradient(to bottom right, #CA3237, #B637FB );">
                            <h5 class="card-title" style="color: white"><strong>{{$item->judul}}</strong></h5>
                            <p class="card-text" style="color: white">{{$item->penulis}}</p>
                        </div>
                        </div>
                    </div>
                @endforeach
