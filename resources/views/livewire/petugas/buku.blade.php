            ...
            <table class="table table-hover text-nowrap">
                ...
                @foreach ($buku as $item)
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                <span wire:click="show({{$item->id}})" class="btn btn-sm btn mr-2" style="background: #C92BDC">Lihat</span>
                                <span wire:click="edit({{$item->id}})" class="btn btn-sm btn mr-2" style="background: #2BDCA9">Edit</span>
                                <span wire:click="delete({{$item ->id}})" class="btn btn-sm btn-danger" style="background: #DC2B2B">Hapus</span>
                            </div>
                        </td>
                    </tr>
                @endforeach
